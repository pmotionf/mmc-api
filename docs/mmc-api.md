...
!!! example
    ...
    === "python"
        ...
        request.command.move.velocity = 40
        request.command.move.acceleration = 40
...
!!! example
    ...
    === "python"
        ...
        request.command.push.velocity = 40
        request.command.push.acceleration = 40
...
!!! example
    ...
    === "python"
        ...
        request.command.pull.velocity = 40
        request.command.pull.acceleration = 40  
